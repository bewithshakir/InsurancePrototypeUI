...
class CarVideo extends Component {
  ...
  componentWillReceiveProps(previosprops, nextprops) {
    ...
    this.player = videojs(document.getElementById('video-js'), previosprops.videoOptions, function onPlayerReady() {
  ...
  render() {
    return (
      <div className="video-container">
        <div data-vjs-player>
          <video ref={node => (this.videoNode = node)} className="video-js" id="video-js" />
        </div>
      </div>
    );
  }
